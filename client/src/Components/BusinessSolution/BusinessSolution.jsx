  ...
  const BusinessSolutions = () => {
    ...
    const services = [
      {
        ...
        description:
          <>Delivering clear, compelling messaging that <br/> aligns with your goals and resonates with <br/> stakeholders.</>,
        link: "#",
      ...
      },
      {
        ...
        description:
          <>Creating impactful brand narratives that <br/> strengthen identity and connect with your <br/> target audience.</>,
        link: "#",
        bgColor: "bg-white text-black",
      ...
      },
      {
        ...
        description:
          <>Empowering your brand with data-driven <br/> strategies to reach and engage your <br/> audience online effectively.</>,
        link: "#",
        bgColor: "bg-white text-black",
      ...
      },
      {
        ...
        description:
          <>Creating user-friendly and innovative mobile <br/> applications tailored to enhance your <br/> business operations.</>,
        link: "#",
        bgColor: "bg-white text-black",
        icon: <FaSearchPlus className="text-4xl text-red-600" />,
      },
      {
        ...
        description:
          <>Building responsive, high-performance <br/> websites that deliver exceptional user <br/> experiences and drive growth.</>,
        link: "#",
        bgColor: "bg-white text-black",
      ...
      },
      {
        ...
        description:
          <>Crafting impactful campaigns to boost brand <br/> visibility and foster meaningful connections <br/> on social platforms.</>,
        link: "#",
        bgColor: "bg-white text-black",
    ...
    return (
        ...
        >
          ...
          ></div>
          <div className="relative z-10 px-8 py-16 lg:w-[1440px] mx-auto">
            {/* Header Section */}
            ...
            <div className="grid grid-cols-1 gap-8 mt-16 md:grid-cols-2 lg:grid-cols-3 lg:relative lg:-translate-y-[5%] lg:w-[1440px]">
              ...
              {services.map((service, index) => (
                <div
                  ...
                  className={`${
                    selectedService === index ? "bg-[#673AB7] text-white" : service.bgColor
                  } p-6 rounded-lg shadow-lg flex flex-col items-start lg:w-[460.21px] lg:h-[317.5px] cursor-pointer transition-colors duration-300 lg:pl-[50px]`}
                >
                  {/* Icon */}
                  <div className="mb-3 pt-[49.2px] ">
                    {React.cloneElement(service.icon, {
                      className: `${selectedService === index ? "text-white" : service.icon.props.className}  text-4xl`,
                    })}
                  </div>
                  {/* Title */}
                  <h2 className="font-sanss text-[25px] font-[600] ">{service.title}</h2>
                  {/* Description */}
                  <p className="mt-2 text-[13px] lg:text-[15px] font-[300] font-sanss leading-[24px] tracking-wide">{service.description}</p>
                  {/* Link */}
                  <a
                    href={service.link}
