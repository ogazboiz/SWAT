...
const FeaturesSection = () => {
  return (
    <div className="flex font-sanss flex-col lg:flex-row items-stretch justify-center bg-red-500 lg:pb-1 lg:space-x-0 ">
      ...
      <div className="flex-1 bg-purple-500 flex flex-row justify-center items-center  text-white py-8 px-6 space-x-3 ">
      ...
      <div className="flex-1 bg-red-500 flex flex-row justify-center items-center">
      ...
      <div className=" w-[20%] h-full bg-[#673AB7] text-white py-8 px-6">
